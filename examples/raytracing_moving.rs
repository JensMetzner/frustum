use frustum::{Frustum, FrustumPath, Point3, Vec3, WorldSpace};
use palette::*;
use rayon::prelude::*;
...
fn main() {
    ...
    let camera_path = FrustumPath {
        key_frustums: vec![
            Frustum {
                origin: Point3::<WorldSpace>::new(-10.0, 0.0, 0.0),
            ...
            Frustum {
                origin: Point3::<WorldSpace>::new(-7.0, 0.0, 7.0),
                target: Point3::<WorldSpace>::new(0.0, 0.0, 0.0),
                fovy: 40.0,
                ncp: 1.0,
                fcp: 20.0,
    ...
    camera_path
        ...
        .for_each(|(idx, camera)| {
            ...
            image::save_buffer(
                format!("raytracing_{:04}_result.png", idx),
                &data,
                camera.width as u32,
